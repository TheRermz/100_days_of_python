...
try:
    data = pd.read_csv("day_31/data/words_to_learn.csv")
...
check = PhotoImage(file="day_31/images/right.png")
check_btn = Button(image=check, highlightthickness=0, command=is_known)
